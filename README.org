...
* Installation
  ...
  To use this library, unpack it in the root directory of your C project. Rename the unpacked =tldevel-XXX=  =tldevel= and make sure the main =configure.ac= file knows about it: 
  ...
  Add lib_tldevel to subdirs in =Makefile.am=: 
